...
print(
    "There are {} triangulars, {} squares, {} pentagonals, {} hexagonals, {} heptagonals, {} octagonals with last two str_digits not the first two str_digits in at least two other sets".
        format(len(triangulars), len(squares), len(pentagonals), len(hexagonals), len(heptagonals), len(octagonals)))

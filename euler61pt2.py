            ...
            for hx in hexagonals:
                ...
                for hp in heptagonals:
                    ...
                    for oc in octagonals:
                        ...
                        if c < 1:
                            break
                        tuple = tr, pe, hx, hp, oc
                        c = how_many_numbers_have_last_two_digits(firsttwosq, tuple)
                        if c < 1:
                            break
                        c = how_many_numbers_have_first_two_digits(lasttwosq, tuple)
                        if c < 1:
                            break
                        tuple = tr, sq, hx, hp, oc
                        c = how_many_numbers_have_last_two_digits(firsttwope, tuple)
                        if c < 1:
                            break
                        c = how_many_numbers_have_first_two_digits(lasttwope, tuple)
                        if c < 1:
                            break
                        tuple = tr, sq, pe, hp, oc
                        c = how_many_numbers_have_last_two_digits(firsttwohx, tuple)
                        if c < 1:
                            break
                        c = how_many_numbers_have_first_two_digits(lasttwohx, tuple)
                        if c < 1:
                            break
                        tuple = tr, sq, pe, hx, oc
                        c = how_many_numbers_have_last_two_digits(firsttwohp, tuple)
                        if c < 1:
                            break
                        c = how_many_numbers_have_first_two_digits(lasttwohp, tuple)
                        if c < 1:
                            break
                        setOfEach.clear()
                        setOfEach.add(tr)
